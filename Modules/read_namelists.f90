...
!
     ...
     SUBROUTINE electrons_defaults( prog )
       ...
       emass = 400.0_DP
       !SHERIF
       emass_preconditioning = .true.
       enable_hole_mass = .false.
       hmass = emass
       emptymass = emass
       !END SHERIF
       emass_cutoff = 2.5_DP
...
!=======================================================================
     ...
     SUBROUTINE electrons_bcast()
       ...
       !
      !SHERIF
       CALL mp_bcast( emass_preconditioning,ionode_id, intra_image_comm )
       CALL mp_bcast( enable_hole_mass,     ionode_id, intra_image_comm )
       CALL mp_bcast( hmass,                ionode_id, intra_image_comm )
       CALL mp_bcast( emptymass,            ionode_id, intra_image_comm )
      !END SHERIF
