...
!=----------------------------------------------------------------------------=!
        ...
        !SHERIF
        LOGICAL :: emass_preconditioning = .true.
        LOGICAL :: enable_hole_mass = .false.
        LOGICAL :: enable_color_field = .false.
        REAL(DP) :: hmass = 0.0_DP
        REAL(DP) :: emptymass = 0.0_DP
        !END SHERIF
       ...
       INTEGER  :: epol2 = 3
        ...
        NAMELIST / electrons / emass, emass_cutoff, orthogonalization, &
          ...
          !SHERIF
          emass_preconditioning, enable_hole_mass, hmass,              &
          enable_color_field, emptymass
          !END SHERIF
